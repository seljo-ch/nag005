<div>
    <x-form wire:submit="save">
        ...
        <x-input label="Empfänger" icon="o-user" wire:model="recipientEmail" clearable />
        ...
        <x-select label="Vordefinierte Nachrichten" icon="o-user" :options="$messages" wire:model="selectedMessage" />
        <x-input label="Betreff" placeholder="" wire:model="subject" icon="o-user" clearable />
